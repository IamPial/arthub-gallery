...
import BuyerLayout from "@/components/dashboard/DashBoardSideBar";
import { Button, Card } from "@heroui/react";
import Image from "next/image";
import Link from "next/link";
import { FiArrowUpRight } from "react-icons/fi";

import art1 from "@/assets/banner1.png";
import art2 from "@/assets/banner2.png";

const BoughtArtworksPage = () => {
  const boughtArtworks = [
    { id: "1", title: "Cute Cube Cool", artist: "John Abraham", image: art1 },
    { id: "2", title: "Liquid Wave", artist: "Alex Panda", image: art2 },
  ];
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-slate-400">
          Your collection of premium certified masterpieces
        </p>
      </div>
          ...
          >
            ...
            <div className="p-5 flex flex-col gap-3 items-start bg-[#1a163a]/60 backdrop-blur-md border-t border-white/5">
              ...
              <Button
                ...
                className="w-full bg-[#6f4ff2] hover:bg-[#5b3ed4] text-white font-semibold rounded-xl text-xs transition-all shadow-md mt-1"
              >
                View Details
              </Button>
            </div>
